...
Date2 = Mobile.getText(findTestObject('Draft/Date2',[('Verify'):findTestData('Draft').getValue(4,7)]), 0)
...
Mobile.takeScreenshot('Screenshot/Draft/Consent10.png')
...
Mobile.takeScreenshot('Screenshot/Draft/Consent11.png')
