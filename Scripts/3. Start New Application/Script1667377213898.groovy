...
Mobile.tapAtPosition(Mobile.getDeviceWidth()/5,Mobile.getDeviceHeight()*11/12)
...
'please fill up...'
Mobile.verifyEqual(Mobile.getText(findTestObject('followingTextnoView', [('Verify') : findTestData('TestData').getValue(4, 37)]), 0), findTestData(
        'TestData').getValue(4, 38))

'existing cust...'
Mobile.verifyEqual(Mobile.getText(findTestObject('Text', [('Verify') : findTestData('TestData').getValue(4, 39)]), 0), findTestData(
        'TestData').getValue(4, 39))
...
if (Choice == '1 Applicant') {
    ...
    Mobile.scrollToText(findTestData('TestData').getValue(4, 57), FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.verifyElementExist(findTestObject('Object Repository/Apply/YesCRS'), 0)
        ...
        'ntb cust'
        Mobile.verifyEqual(Mobile.getText(findTestObject('Object Repository/Apply/NTBerror'), 
...
//        Mobile.takeScreenshot('Screenshot/Validation/staff MBB.png')
		...
		Mobile.takeScreenshot('Screenshot/Validation/WrongAge2.png')
...
//        Mobile.takeScreenshot('Screenshot/Validation/BlankBranchApproval.png')
    ...
    Mobile.verifyEqual(NRIC, findTestData('TestData').getValue(5, 56))
}
...
if (Mobile.verifyElementExist(findTestObject('Text', [('Verify') : findTestData('TestData').getValue(5, 61)]), 0, FailureHandling.OPTIONAL)) {
    'Weve prefilled'
    Mobile.verifyEqual(Mobile.getText(findTestObject('Apply/Existing Cust'), 0), findTestData('TestData').getValue(5, 61))
...
//    Mobile.callTestCase(findTestCase('4. Confirmation'), [:], FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.callTestCase(findTestCase('3a. Step 1'), [NRIC1:NRIC], FailureHandling.CONTINUE_ON_FAILURE)
}
